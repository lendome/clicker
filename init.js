...
if (parseInt(localStorage.getItem("init")) != 1) {
  ...
  let availableRE = [
    ...
    },
    {
      ...
      price: 7500,
      rentIncome: 400,
      img: "https://images.unsplash.com/photo-1617655699589-64375e5ad9a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fHBpenphJTIwc2hvcHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=1200&q=60",
    },
    {
  ...
  let vehicles = [
    { name: "cheap bike", price: 40 },
    { name: "Okay-ish bike", price: 60 },
    { name: "Used Colf 1 (bad condition)", price: 700 },
    { name: "aodi a5 2001", price: 1100 },
    { name: "cheap hatchback", price: 2000 },
    { name: "Eord fusion", price: 10000 },
    { name: "school bus", price: 12000 },
    { name: "walk (less carbon footprint)", price: 0 },
    { name: "lombargine machine", price: 300000 },
    { name: "Roys roys", price: 500000 },
  ];
  let ownedVehicles = [
